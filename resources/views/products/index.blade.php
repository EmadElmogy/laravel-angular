...
@section('body')
    ...
    <div class="page-header">
        <div class="page-header-content">
            <div class="page-title"><h4>Products Management</h4></div>

            <div class="heading-elements">
                <div class="heading-btn-group">
                    <a href="{{url('products/item')}}" class="btn btn-link btn-float has-text"><i class="icon-plus-circle2 text-primary"></i><span>Add New</span></a>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="col-md-12">
                ...
                <div class="row mb-20">
                    <form action="">
                        ...
                        <div class="col-md-2">
                            <select name="filters[category_id]" class="form-control select2">
                                {!! selectBoxOptionsBuilder([''=>'Please Select']+groupedSelectBoxArrayBuilder(\App\Category::with('children')->get(), 'children'), request('filters.category_id')) !!}
                            </select>
                        </div>
                        <div class="col-md-2">
