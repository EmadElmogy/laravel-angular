...
<head>
    ...
    <script type="text/javascript" src="<?php echo e(asset('assets/js/plugins/ui/nicescroll.min.js')); ?>"></script>
    <script type="text/javascript" src="<?php echo e(asset('assets/js/plugins/ui/drilldown.js')); ?>"></script>
    <!-- /core JS files -->
    ...
    <div class="page-content">
        ...
        <div class="content-wrapper" style="background: #000">
            ...
            <div class="text-center mb-20">
                <img src="<?php echo e(url('assets/images/logo_light.png')); ?>" alt="">
            </div>
            ...
            <div class="panel panel-body login-form">
                <div class="text-center">
                    ...
                    <a class="btn btn-primary" href="<?php echo e(url('/')); ?>">Return to dashboard</a>
                </div>
