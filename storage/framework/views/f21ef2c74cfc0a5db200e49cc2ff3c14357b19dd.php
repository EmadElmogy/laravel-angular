        ...
        <div class="page-header-content">
            ...
            <div class="heading-elements">
                <div class="heading-btn-group">
                    <a href="<?php echo e(url('contacts/item')); ?>" class="btn btn-link btn-float has-text"><i class="icon-plus-circle2 text-primary"></i><span>Add New</span></a>
                </div>
            </div>
        </div>
    </div>
                            ...
                            <?php $__empty_1 = true; foreach($items as $item): $__empty_1 = false; ?>
                                <tr>
                                    ...
                                    <td class="v-align-middle text-right text-nowrap">
                                        <a href="<?php echo e(url('contacts/item/'.$item->id)); ?>" class="btn btn-primary btn-xs"><i class="icon-pencil5"></i></a>
                                        <a href="<?php echo e(url('contacts/item/'.$item->id)); ?>" class="btn btn-danger btn-xs deleter"><i class="icon-trash"></i></a>
                                    </td>
                                </tr>
