...
<?php $__env->startSection('body'); ?>
    ...
    <div class="page-header">
        <div class="page-header-content">
            <div class="page-title"><h4>Admins Management: <?php echo e($item->id ? $item->name : 'Add New'); ?></h4></div>
        </div>
    </div>
                ...
                <form role="form" method="post" autocomplete="off" class="form-horizontal form-validate-jquery">
                    ...
                    <fieldset class="content-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-10">
                                <input type="password" class="form-control" <?php echo e(!$item ? 'required="required"' : ''); ?> name="password">
                            </div>
                        </div>
                    </fieldset>
